...
HD_PWD='C:/Users/RESEARCH/Downloads/Quadrature/Quadrature/FPGA_part/targeting/servo_encoder_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_enc_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source servo_enc_v1_0.tcl
