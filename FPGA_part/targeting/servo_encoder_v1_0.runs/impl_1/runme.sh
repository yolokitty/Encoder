...
HD_PWD='C:/Users/RESEARCH/Downloads/Quadrature/Quadrature/FPGA_part/targeting/servo_encoder_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log servo_enc_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source servo_enc_v1_0.tcl -notrace
