...
REM
REM Generated by Vivado on Tue Apr 14 15:24:43 +0900 2026
...
echo "xvhdl --incr --relax -prj servo_enc_v1_0_vhdl.prj"
call xvhdl  --incr --relax -prj servo_enc_v1_0_vhdl.prj -log xvhdl.log
