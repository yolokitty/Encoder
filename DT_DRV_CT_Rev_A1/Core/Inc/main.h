...
#define FPGA_INITn_Pin GPIO_PIN_1
#define FPGA_INITn_GPIO_Port GPIOB
#define FPGA_PRGn_Pin GPIO_PIN_0
#define FPGA_PRGn_GPIO_Port GPIOB
#define FPGA_RESETn_Pin GPIO_PIN_11
